...
/**
 * The persistent class for the MST_CALL_RATE database table.
 * 
 */
@Entity
@Table(name="MST_CALL_RATE")
@NamedQuery(name="MstCallRate.findAll", query="SELECT m FROM MstCallRate m")
public class MstCallRate implements Serializable {
	...
	@Column(name="CALL_RATE_NAME")
	private String callRateName;
	...
	@Column(name="PARENT_CALL_RATE_ID")
	private BigDecimal parentCallRateId;
	...
	@OneToMany(mappedBy="mstCallRate")
	...
	public String getCallRateName() {
		return this.callRateName;
	}

	public void setCallRateName(String callRateName) {
		this.callRateName = callRateName;
	}
	...
	public BigDecimal getParentCallRateId() {
		return this.parentCallRateId;
	}

	public void setParentCallRateId(BigDecimal parentCallRateId) {
		this.parentCallRateId = parentCallRateId;
	}
